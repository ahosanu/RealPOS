...
//if (isset($_SESSION['id'])) {
    ...
    $result = $conn->query("SELECT us_id as number ,us_id,full_name,mobile,address,photo,us_id as total_shop,us_id as point,email FROM `user` WHERE us_id NOT IN (SELECT us_id FROM `user_security`) and us_id = '".$_GET['id']."'");
